...
import com.example.ecom.databinding.OrderItemBinding
        ...
        fun bind(order: Order){
            binding.apply {
                ...
                val colorDrawable = when(getOrderStatus(order.orderStatus)) {
                    ...
                    is OrderStatus.Cancelled -> ColorDrawable(resources.getColor(R.color.g_green))
                    ...
                    is OrderStatus.Shipped -> ColorDrawable(resources.getColor(R.color.g_red))
                }
